...
// clang-format off
const int rp1_bank_base[] = {0, 28, 34};

const char *rp1_gpio_fsel_names[RP1_NUM_GPIOS][RP1_FSEL_COUNT] =
{
...
void rp1_gpio_sys_rio_out_write(volatile uint32_t *base, int bank, int offset,
                                       uint32_t value)
{
  UNUSED(offset);
...
const GPIO_CHIP_INTERFACE_T rp1_gpio_interface = {
