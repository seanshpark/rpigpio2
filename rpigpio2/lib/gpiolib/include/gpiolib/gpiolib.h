#ifndef __RPIGPIO2_LIB_GPIOLIB_GPIOLIB_H__
#define __RPIGPIO2_LIB_GPIOLIB_GPIOLIB_H__
...
{
  const GPIO_CHIP_T *chip = nullptr;
  const char *name = nullptr;
  const char *dtnode = nullptr;
  int mem_fd = -1;
  void *priv = nullptr;
  uint64_t phys_addr = 0;
  unsigned num_gpios = 0;
  uint32_t base = 0;
...
#endif // __RPIGPIO2_LIB_GPIOLIB_GPIOLIB_H__
